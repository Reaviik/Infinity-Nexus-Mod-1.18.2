...
public class ModItems {
    ...
    //TODO configs
    public static final RegistryObject<Item> IMPERIAL_3D_INFINITY_SWORD = ITEMS.register("imperial_3d_infinity_sword",
            () -> new ModSword(ModTiers.IMPERIAL, ModCommonConfigs.I_I_S_DAMAGE.get(), ModCommonConfigs.I_I_S_SPEED.get(),
                    ...
                    new TranslatableComponent("tooltip.infinity_nexus_mod.imperial_3d_infinity_sword"),
    ...
    public static final RegistryObject<Item> INFINITY_HELMET = ITEMS.register("imperial_infinity_helmet",() -> new ImperialArmorItem(ModArmorMaterials.IMPERIAL, EquipmentSlot.HEAD,
                    new Item.Properties().tab(ModTabs.INFINITY_NEXUS).stacksTo(1).rarity(Rarity.EPIC).fireResistant()));
    public static final RegistryObject<Item> INFINITY_CHESTPLATE = ITEMS.register("imperial_infinity_chestplate",() -> new ImperialArmorItem(ModArmorMaterials.IMPERIAL, EquipmentSlot.CHEST,
                    new Item.Properties().tab(ModTabs.INFINITY_NEXUS).stacksTo(1).rarity(Rarity.EPIC).fireResistant()));
    public static final RegistryObject<Item> INFINITY_LEGGINGS = ITEMS.register("imperial_infinity_leggings",() -> new ImperialArmorItem(ModArmorMaterials.IMPERIAL, EquipmentSlot.LEGS,
                    new Item.Properties().tab(ModTabs.INFINITY_NEXUS).stacksTo(1).rarity(Rarity.EPIC).fireResistant()));
    public static final RegistryObject<Item> INFINITY_BOOTS = ITEMS.register("imperial_infinity_boots",() -> new ImperialArmorItem(ModArmorMaterials.IMPERIAL, EquipmentSlot.FEET,
                    new Item.Properties().tab(ModTabs.INFINITY_NEXUS).stacksTo(1).rarity(Rarity.EPIC).fireResistant()));
    //Infinity
    ...
    public static final RegistryObject<Item> INFINITY_HOE = ITEMS.register("infinity_hoe",() -> new HoeItem(ModTiers.INFINITY, ModCommonConfigs.I_T_DAMAGE.get(), ModCommonConfigs.I_T_SPEED.get(),
                    new Item.Properties().tab(ModTabs.INFINITY_NEXUS).fireResistant()));
    public static final RegistryObject<Item> INFINITY_INFINITY_HELMET = ITEMS.register("infinity_helmet",() -> new InfinityArmorItem(ModArmorMaterials.INFINITY, EquipmentSlot.HEAD,
                    new Item.Properties().tab(ModTabs.INFINITY_NEXUS).stacksTo(1).rarity(Rarity.RARE).fireResistant()));
    public static final RegistryObject<Item> INFINITY_INFINITY_CHESTPLATE = ITEMS.register("infinity_chestplate",() -> new InfinityArmorItem(ModArmorMaterials.INFINITY, EquipmentSlot.CHEST,
                    new Item.Properties().tab(ModTabs.INFINITY_NEXUS).stacksTo(1).rarity(Rarity.RARE).fireResistant()));
    public static final RegistryObject<Item> INFINITY_INFINITY_LEGGINGS = ITEMS.register("infinity_leggings",() -> new InfinityArmorItem(ModArmorMaterials.INFINITY, EquipmentSlot.LEGS,
                    new Item.Properties().tab(ModTabs.INFINITY_NEXUS).stacksTo(1).rarity(Rarity.RARE).fireResistant()));
    public static final RegistryObject<Item> INFINITY_INFINITY_BOOTS = ITEMS.register("infinity_boots",() -> new InfinityArmorItem(ModArmorMaterials.INFINITY, EquipmentSlot.FEET,
                    new Item.Properties().tab(ModTabs.INFINITY_NEXUS).stacksTo(1).rarity(Rarity.RARE).fireResistant()));
